...
const Lesson3Screen = ({ navigation }) => {
    ...
    const handleContinuePress = () => {
        ...
        navigation.navigate('Lesson4Screen', { lives });
    };

    const handleSpeech = () => {
        Speech.speak("icecream");
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.optionsContainer}>
                {[
                    { image: require('../assets/image 45.png'), label: 'sô-cô-la' },
                    { image: require('../assets/image 46.png'), label: 'kem' },
                    { image: require('../assets/image 47.png'), label: 'em bé' },
                    { image: require('../assets/image 48.png'), label: 'màu vàng' },
                ].map((option, index) => (
                    <TouchableOpacity
                        key={index}
                        style={[
