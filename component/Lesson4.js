...
const Lesson4Screen = ({ navigation, route }) => {
    ...
    const handleCheckPress = () => {
        const correct = selectedOption === 2; // Assuming "pretty" at index 1 is the correct answer
    ...
    const handleContinuePress = () => {
        ...
        navigation.navigate('Lesson5Screen', { lives });
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.title}>Làm sao để nói "tin nhắn"?</Text>


            <View style={styles.optionsContainer}>
                {['trip', 'tomorrow', 'message'].map((option, index) => (
                    <TouchableOpacity
                        key={index}
                        style={[
                            styles.optionButton,
