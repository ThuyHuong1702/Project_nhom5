...
const Screen8 = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Question Prompt */}
      <Text style={styles.questionTitle}>Hoàn thành câu</Text>

      {/* Character with Speech Bubble */}
      <View style={styles.characterContainer}>
        <Image style={styles.characterImage} source={require('../images/dolphin.png')} />
        <View style={styles.speechBubble}>
          <Text style={styles.speechText}>I ____ busy today.</Text>
          <Text style={styles.speechText}>I won’t ____ at your party.</Text>
        </View>
      </View>
