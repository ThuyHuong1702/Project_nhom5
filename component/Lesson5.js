        ...
        <View style={styles.container}>
            ...
            <View style={styles.dialogContainer}>
                <ImageBackground source={require('../assets/Group 8.png')} style={styles.speechBubble} resizeMode="contain">
                    <TouchableOpacity onPress={() => handleSpeech("Is that your younger sister?")}>
                        <Ionicons name="volume-high" size={16} color="#00C3FE" style={styles.audioIcon} />
                    </TouchableOpacity>
                    <Text style={styles.speechText}>Is that your younger sister?</Text>
                </ImageBackground>
            ...
            <View style={styles.optionsContainer}>
                {["No, that's my older sister!.", "No, that isn't my older sister!."].map((option, index) => (
                    <TouchableOpacity
                        key={index}
                        style={[
                            styles.optionButton,
